...
class MetricsComputeTool:
    ...
    def run_algorithm(self, algo_name, gds_proc, key_name, limit=None):
        ...
        elif "triangleCount" in gds_proc:
            yield_field = "triangleCount"
        elif "hits" in gds_proc:
            yield_field = "auth"
...
def main():
    ...
    try:
        ...
        algo_map = {
            ...
            "triangleCount": ("Triangle Count", "gds.triangleCount.stream", "triangle_count", "UNDIRECTED"),
            "hits": ("HITS Authority", "gds.hits.stream", "auth_score", "NATURAL")
        }
